...
export default function YouTubeCD() {
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen py-20 text-white">
      {videos.map((v, i) => {
        const isEven = i % 2 === 0;
        return (
          <div
            key={i}
            className={`flex flex-col md:flex-row items-center justify-center w-full my-16 px-8 gap-12 ${
          ...
          >
            ...
            <div className="max-w-2xl text-2xl font-bold leading-relaxed text-center md:text-left">
              <p>{v.text}</p>
            </div>
          </div>
        );
